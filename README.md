...
The generated HTML site can be previewed here: https://srid.github.io/adliya/
...
- As a first step to using this template, 
  - change the project name in .cabal, flake.nix and hie.yaml files; then commit changes to Git.
      - To automate this, `mv adliya.cabal myproject.cabal; nix run nixpkgs#sd -- adliya myproject * */* .github/*/*`
- Configuration:
